...
const wordList = [
    ...
    { word: "myntra", hint: "online shopping site" },
    ...
    { word: "github", hint: "code hosting platform" },
    { word: "jaipur", hint: "pink city of india" },
    { word: "asus", hint: "a laptop brand" },
    { word: "sony", hint: "brand of TV" },
    { word: "bru", hint: "a coffee brand" },
    { word: "daisy", hint: "name a flower" },
    { word: "mango", hint: "name a fruit" },
]